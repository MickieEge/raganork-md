...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/ME7up8d.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'G-WIN;G-BOT;0;https://i.imgur.com/ME7up8d.jpeg',
    RBG_KEY: process.env.RBG_KEY || 'YXCTj3mp5reqS8E3qCjosXew',
    ...
    ANTILINK_WARN: process.env.ANTILINK_WARN || 'warn',
    HEROKU: {
